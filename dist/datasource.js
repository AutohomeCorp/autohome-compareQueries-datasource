define(['angular', 'lodash', 'moment'], function (angular, _, moment) {
    ...
    function CompareQueriesDatasource($q, datasourceSrv, templateSrv) {
                            ...
                            var comparePromise = _this.datasourceSrv
                                ...
                                .then(function (compareResult) {
                                    ...
                                    data.forEach(function (line) {
                                        ...
                                        if (line.target) {
                                            line.target = generalAlias(line.target, timeShiftAlias, aliasType, delimiter)
                                            typeof line.title != 'undefined' && line.title != null && (line.title = generalAlias(line.title, timeShiftAlias, aliasType, delimiter))
                                        } else if (line.fields) {
                                            line.name = generalAlias(line.name, timeShiftAlias, aliasType, delimiter)
                                        }
        ...
        function generalAlias(original, alias, aliasType, delimiter) {
            switch (aliasType) {
                case "prefix":
